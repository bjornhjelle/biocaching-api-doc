...
comment_params = {comment: {text: 'denne kommentaren er oppdatert'}}
...
begin
  ...
  response = RestClient.put "http://#{@server}/observations/#{o_id}/comments/9", comment_params, @http_headers
