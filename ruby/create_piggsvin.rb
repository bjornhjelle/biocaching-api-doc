...
observation_params = {observation: {taxon_id: 31619, comments: "Fant denne i hagen", observed_at: Time.now.to_s, latitude: 58.4, longitude: 11.3, picture: File.new("../pictures/piggsvin.jpg", 'rb')}, :multipart => true, :content_type => 'application/json'}
