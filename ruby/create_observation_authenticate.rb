...
begin
  # authenticate
  response = RestClient.post('http://localhost:3001/users/sign_in.json', authenticate_params)
  ...
  response = RestClient.post 'http://localhost:3001/api/observations', observation_params, http_headers
