...
observation_params = {observation: {taxon_id: 611, comments: "Så denne på en tur ved Sognsvann", observed_at: Time.now.to_s, latitude: 59.96, longitude: 10.72, picture: File.new("../pictures/elg.jpg", 'rb')}, :multipart => true, :content_type => 'application/json'}
